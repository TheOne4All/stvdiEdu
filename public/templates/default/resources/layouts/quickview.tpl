        ...
        <div class="tab-pane active no-padding" id="quickview-chat">
            <div class="view-port clearfix" id="chat">
                                    ...
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                        ...
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt=""
                                                data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/1x.jpg"
                                                data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/1.jpg" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/1x.jpg"
                                                class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                        ...
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt=""
                                                data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/2x.jpg"
                                                data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/2.jpg" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/2x.jpg"
                                                class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                        ...
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt=""
                                                data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/3x.jpg"
                                                data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/3.jpg" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/3x.jpg"
                                                class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                        ...
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt=""
                                                data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/4x.jpg"
                                                data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/4.jpg" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/4x.jpg"
                                                class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                        ...
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt=""
                                                data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/5x.jpg"
                                                data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/5.jpg" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/5x.jpg"
                                                class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                        ...
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt=""
                                                data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/6x.jpg"
                                                data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/6.jpg" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/6x.jpg"
                                                class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                        ...
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt=""
                                                data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/7x.jpg"
                                                data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/7.jpg" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/7x.jpg"
                                                class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                        ...
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt=""
                                                data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/8x.jpg"
                                                data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/8.jpg" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/8x.jpg"
                                                class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view"
                                        ...
                                        <span class="thumbnail-wrapper d32 circular bg-success">
                                            <img width="34" height="34" alt=""
                                                data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/9x.jpg"
                                                data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/9.jpg" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/9x.jpg"
                                                class="col-top">
                                        </span>
                                        <p class="p-l-10 ">
                ...
                <div class="view chat-view bg-white clearfix">
                    ...
                    <div class="navbar navbar-default">
                        <div class="navbar-inner">
                            <a href="javascript:;" class="link text-color action p-l-10 p-r-10" data-navigate="view"
                                data-view-port="#chat" data-view-animation="push-parrallax">
                    ...
                    <div class="chat-inner" id="my-conversation">
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/avatar_small.jpg"
                                    alt="" data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/avatar_small.jpg"
                                    data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/avatar_small2x.jpg">
                            </div>
