    ...
    <div class="overlay hide" data-pages="search">
        ...
        <div class="overlay-content has-results m-t-20">
            ...
            <div class="container-fluid">
                <!-- BEGIN Overlay Logo !-->
                <img class="overlay-brand" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/logo.png" alt="logo" data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/logo.png"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex m-t-15">
                                ...
                                <div class="thumbnail-wrapper d48 circular bg-success text-white ">
                                    <img width="36" height="36" src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/avatar.jpg"
                                        data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/avatar.jpg"
                                        data-src-retina="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/avatar2x.jpg" alt="">
                                </div>
