                                    ...
                                    <div class="heading">
                                        <div
                                            ...
                                            <img width="30" height="30"
                                                ...
                                                data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/1.jpg"
                                                alt=""
                                                src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/1.jpg">
                                        </div>
        ...
        <div class="dropdown pull-right d-lg-block d-none">
            <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true"
                ...
                <span class="thumbnail-wrapper d32 circular inline">
                    <img src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/avatar.jpg" alt=""
                        data-src="<?=FYNX_PUBLIC['template_url']?>default/assets/img/profiles/avatar.jpg"
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                ...
                <a href="<?=FYNX_PUBLIC['url'] . 'auth/signout/' . $_SESSION['user_session']['org_id']?>"
