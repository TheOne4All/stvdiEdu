                                ...
                                <div class="container-xs-height full-height">
                                    <div class="row row-xs-height">
                                        <div class="col-xs-5 col-xs-height col-middle relative">
                                            <div
                                                class="padding-15 full-height d-flex flex-column justify-content-between">
                                                <p class=" hint-text">Today's sales</p>
                                                <div>
                                                    <h3 class="hint-text no-margin text-ellipsis">
                                                        ...
                                                        <ul class="list-inline ">
                                                            <li>
                                                                <a href="#" class="no-decoration"><i
                                                                        class="pg-icon">comment_alt</i>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#" class="widget-3-fav no-decoration"><i
                                                                        class="pg-icon">heart_outline</i>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <div class="slide-front tiles slide active">
                                            <div class="padding-25">
                                                <div class="pull-bottom padding-25 bottom-right bottom-left">
                                                    ...
                                                    <p class="no-margin hint-text text-ellipsis">NASDAQ : AAPL - NOV
                                                        018:40 AM ET</p>
                                                    <h3 class="semi-bold"><i class="pg-icon">arrow_up</i> 0.15
                                                        (0.13%)
                                                    </h3>
                                                    <p>Open
                                ...
                                <div class="row-xs-height ">
                                    <div class="col-xs-height col-top relative">
                                        <div class="row full-height">
                                            <div class="col-sm-6">
                                                <div
                                                    class="p-l-20 full-height d-flex flex-column justify-content-between">
                                                    <h3 class="no-margin p-b-5">$14,000</h3>
                                                    <p class="small m-t-5 m-b-20">
                                                        <span
                                                            class="label label-white hint-text font-montserrat m-r-5">60%</span><span
                                                            class="fs-12">Higher</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class='widget-8-chart line-chart' data-line-color="white"
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="d-flex align-items-center pull-left small">
                                            <span>WMHC</span>
                                            <span class=" text-success"> <i class="pg-icon m-l-10">arrow_up</i>
                                            </span>
                                            <span class="text-success font-montserrat"> 21% </span>
                                        </div>
                                        <div class="d-flex align-items-center pull-left m-l-20 small">
                                            <span>HCRS</span>
                                            <span class="text-danger"><i class="pg-icon m-l-10">arrow_down</i>
                                            </span>
                                ...
                                <div class="row">
                                            ...
                                            <div class="full-width">
                                                <ul class="list-inline m-t-10 p-b-10 m-b-0 b-b b-dashed b-grey">
                                                    ...
                                                    <li class="active"><a href="#"
                                                            class="font-montserrat fs-12   bg-contrast-low text-color">5D</a>
                                                    </li>
                                    ...
                                    <div class="col-xlg-4 visible-xlg p-l-15">
                                        <div class="widget-12-search">
                                            ...
                                            <button aria-label=""
                                                class="btn btn-default btn-rounded btn-icon pull-right">
                                        ...
                                        <div class="company-stat-boxes">
                                            ...
                                            <div data-index="1"
                                                class="company-stat-box active p-l-5 p-r-5 p-t-15 p-b-10 b-b b-grey">
                                                <div class="pull-left">
                                                    <p class="company-name pull-left text-uppercase bold no-margin">
                                            ...
                                            <div data-index="4"
                                                class="company-stat-box active p-l-5 p-r-5 p-t-15 p-b-10">
                                                <div class="pull-left">
                                                    <p class="company-name pull-left text-uppercase bold no-margin">
                                        ...
                                        <span class="pull-bottom hint-text small">VIA YAHOO Finance (Stock market
                                            API)(800) MY-STOCKS (800-692-7753)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container-xs-height full-height">
                                ...
                                <div class="p-l-20 p-r-20">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 visible-xlg">
                                            <div
                                                class="widget-14-chart-legend bg-transparent text-black no-padding pull-right">
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                        ...
                        <div class="row-xs-height">
                            <div class="col-xs-height relative bg-contrast-lowest">
                                ...
                                <div class="widget-14-chart rickshaw-chart top-left top-right bottom-left bottom-right">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 visible-lg hidden-xlg sm-p-b-10 md-m-b-10">
                ...
                <div class="widget-15-2 card no-margin  widget-loader-circle">
                    ...
                    <div class="p-t-10 p-l-20 p-r-20 p-b-20">
                        <div class="row">
                            <div class="col-md-9">
                                <p class="fs-16">Apple’s Motivation - Innovation distinguishes between A leader and
                                    a follower.
                                </p>
                                <p class="small hint-text">VIA Apple Store (Consumer and Education Individuals)
                                    <br>(800) MY-APPLE (800-692-7753)
                        ...
                        <div class="item-header clearfix">
                            ...
                            <div class="inline m-l-10">
                                ...
                                <p class="no-margin hint-text fs-12 d-flex">Shared a link
                                    <span class="location semi-bold d-flex"><i class="pg-icon">map</i> NY
                                        center</span>
                                </p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-xlg-12">
                        ...
                        <div class="card   no-margin">
                            ...
                            <hr class="no-margin">
                            <div class="padding-15">
                                <p>Crafting Digital Products that merge Humans and Machines. Join the revolution.
                                </p>
                            ...
                            <div class="padding-15">
                                ...
                                <ul class="list-inline pull-right no-margin">
                                    ...
                                    <li><a class="text-color hint-text fs-13 d-flex" href="#"><i
                                                class="pg-icon m-r-5">heart</i> 23K</a>
                                    </li>
                                </ul>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-xlg-6">
                                    ...
                                    <div class="m-t-25 p-b-10">
                                        ...
                                        <a href="#" class="btn-icon-link d-flex pull-right"><i
                                    ...
                                    <div class="widget-17-weather b-t b-grey p-t-20">
                                        <div class="weather-info row">
                                            <div class="col-6 p-r-15">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <p class="pull-left no-margin hint-text fs-13">Precipitation
                                                        </p>
                                            ...
                                            <div class="col-6 p-l-15">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <p class="pull-left no-margin hint-text fs-13">Visibility
                                                        </p>
